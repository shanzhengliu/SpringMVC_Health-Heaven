...
<head>
    ...
    <script src="../statics/js/Food.js"></script>
    ...
    <div class="row">
        <div class="col-5">
            <div class="input-group mb-3" style="margin-top: 50px">
                ...
                <input id="foodName" onchange="handleFoodNameQuery()" type="text" class="form-control" placeholder=""
                       aria-label="" aria-describedby="basic-addon1" style="width: 30px">
            </div>
            <ul id="possibleFoodName" class="list-group">
            </ul>
        ...
        <div class="col-5">
            <div class="input-group mb-3" style="margin-top: 50px">
                <div class="input-group-prepend">
                    <span class="input-group-text">Estimate Amount</span>
                </div>
                <input id="foodAmount" type="text" class="form-control" placeholder="serving" aria-label=""
                       aria-describedby="basic-addon1" style="width: 30px">
            </div>
            <div style="margin-top: 50px">
                <button type="button" class="btn btn-info" style="margin-right: 20px"
                        onclick="handleFoodCalorieQuery()">Query calories
                </button>
                <span>
